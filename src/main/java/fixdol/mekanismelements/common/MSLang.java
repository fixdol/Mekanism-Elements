...
public enum MSLang implements ILangEntry {
    ...
    DESCRIPTION_CHEMICAL_DEMOLITION_MACHINE("description", "chemical_demolition_machine"),
    DESCRIPTION_INFINITY_ORE_REPROCESSING("description", "infinity_ore_reprocessing"),
    ...
    NAME_CHEMICAL_DEMOLITION_MACHINE("block","chemical_demolition_machine"),
    NAME_INFINITY_ORE_REPROCESSING("block","infinity_ore_reprocessing");
