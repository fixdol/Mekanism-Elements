...
import fixdol.mekanismelements.datagen.machines.AdsorptionRecipeProvider;
import fixdol.mekanismelements.datagen.machines.ChemicalDemolitionRecipeProvider;
import fixdol.mekanismelements.datagen.machines.RadiationIrradiatingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.ChemicalInfusingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.CrushingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.ReactionRecipeProvider;
import fixdol.mekanismelements.datagen.machines.NucleosynthesizingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.RotaryRecipeProvider;
import fixdol.mekanismelements.datagen.machines.SeparatingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.CentrifugingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.OxidizingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.EvaporatingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.DissolutionRecipeProvider;
import fixdol.mekanismelements.datagen.machines.PaintingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.CrystallizingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.ActivatingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.InjectingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.WashingRecipeProvider;
import fixdol.mekanismelements.datagen.machines.InfinityOreReprocessingRecipeProvider;
...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput writer) {
        ...
        // chemical demolition 
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, MSBlocks.CHEMICAL_DEMOLITION_MACHINE.get().asItem())
                .pattern("ACA")
                .pattern("SXS")
                .pattern("ATA")
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/beryllium_ingot_from_dust"));
        ...
        SimpleCookingRecipeBuilder.blasting(
                ...
                .group("beryllium_ingot")
                .unlockedBy("has_dust_beryllium", has(MSItems.DUST_BERYLLIUM.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "blasting/beryllium_ingot_from_dust"));
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/dust_calcium_oxide_from_calcite"));
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/dust_calcium_oxide_from_dripstone"));
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/dust_calcium_oxide_from_tube_coral"));
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/dust_calcium_oxide_from_brain_coral"));
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/dust_calcium_oxide_from_bubble_coral"));
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/dust_calcium_oxide_from_fire_coral"));
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "smelting/dust_calcium_oxide_from_horn_coral"));
    ...
    private void addStonecuttingRecipes(RecipeOutput output) {
        addHqcStonecutting(output, "high_quality_concrete", MSBlocks.HIGH_QUALITY_CONCRETE.get(), MSBlocks.HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "aqua_high_quality_concrete", MSBlocks.AQUA_HIGH_QUALITY_CONCRETE.get(), MSBlocks.AQUA_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.AQUA_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "black_high_quality_concrete", MSBlocks.BLACK_HIGH_QUALITY_CONCRETE.get(), MSBlocks.BLACK_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.BLACK_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "blue_high_quality_concrete", MSBlocks.BLUE_HIGH_QUALITY_CONCRETE.get(), MSBlocks.BLUE_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.BLUE_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "brown_high_quality_concrete", MSBlocks.BROWN_HIGH_QUALITY_CONCRETE.get(), MSBlocks.BROWN_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.BROWN_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "cyan_high_quality_concrete", MSBlocks.CYAN_HIGH_QUALITY_CONCRETE.get(), MSBlocks.CYAN_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.CYAN_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "dark_red_high_quality_concrete", MSBlocks.DARK_RED_HIGH_QUALITY_CONCRETE.get(), MSBlocks.DARK_RED_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.DARK_RED_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "gray_high_quality_concrete", MSBlocks.GRAY_HIGH_QUALITY_CONCRETE.get(), MSBlocks.GRAY_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.GRAY_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "green_high_quality_concrete", MSBlocks.GREEN_HIGH_QUALITY_CONCRETE.get(), MSBlocks.GREEN_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.GREEN_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "light_blue_high_quality_concrete", MSBlocks.LIGHT_BLUE_HIGH_QUALITY_CONCRETE.get(), MSBlocks.LIGHT_BLUE_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.LIGHT_BLUE_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "light_gray_high_quality_concrete", MSBlocks.LIGHT_GRAY_HIGH_QUALITY_CONCRETE.get(), MSBlocks.LIGHT_GRAY_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.LIGHT_GRAY_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "lime_high_quality_concrete", MSBlocks.LIME_HIGH_QUALITY_CONCRETE.get(), MSBlocks.LIME_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.LIME_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "magenta_high_quality_concrete", MSBlocks.MAGENTA_HIGH_QUALITY_CONCRETE.get(), MSBlocks.MAGENTA_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.MAGENTA_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "orange_high_quality_concrete", MSBlocks.ORANGE_HIGH_QUALITY_CONCRETE.get(), MSBlocks.ORANGE_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.ORANGE_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "pink_high_quality_concrete", MSBlocks.PINK_HIGH_QUALITY_CONCRETE.get(), MSBlocks.PINK_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.PINK_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "purple_high_quality_concrete", MSBlocks.PURPLE_HIGH_QUALITY_CONCRETE.get(), MSBlocks.PURPLE_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.PURPLE_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "red_high_quality_concrete", MSBlocks.RED_HIGH_QUALITY_CONCRETE.get(), MSBlocks.RED_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.RED_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "white_high_quality_concrete", MSBlocks.WHITE_HIGH_QUALITY_CONCRETE.get(), MSBlocks.WHITE_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.WHITE_HIGH_QUALITY_CONCRETE_STAIRS.get());
        addHqcStonecutting(output, "yellow_high_quality_concrete", MSBlocks.YELLOW_HIGH_QUALITY_CONCRETE.get(), MSBlocks.YELLOW_HIGH_QUALITY_CONCRETE_SLABS.get(), MSBlocks.YELLOW_HIGH_QUALITY_CONCRETE_STAIRS.get());
    }
     ...
     */
    private void addHqcStonecutting(RecipeOutput output, String name, Block base, Block slab, Block stairs) {
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(base), RecipeCategory.BUILDING_BLOCKS, slab, 2)
                ...
                .save(output, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "stonecutting/" + name + "_slab_alt"));

        SingleItemRecipeBuilder.stonecutting(Ingredient.of(base), RecipeCategory.BUILDING_BLOCKS, stairs, 1)
                .unlockedBy("has_" + name, has(base))
                .save(output, ResourceLocation.fromNamespaceAndPath(MekanismElements.MODID, "stonecutting/" + name + "_stairs_alt"));
    }
