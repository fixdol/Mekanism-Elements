...
public class MSContainerTypes {
    ...
    public static final ContainerTypeRegistryObject<MekanismTileContainer<TileEntityInfinityOreReprocessing>> INFINITY_ORE_REPROCESSING;
    ...
    static {
        ...
        INFINITY_ORE_REPROCESSING = CONTAINER_TYPES.register(MSBlocks.INFINITY_ORE_REPROCESSING, TileEntityInfinityOreReprocessing.class);
    }
