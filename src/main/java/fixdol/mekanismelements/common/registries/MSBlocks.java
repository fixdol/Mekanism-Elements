...
public class MSBlocks {
    ...
    public static final BlockRegistryObject<BlockTile.BlockTileModel<TileEntityInfinityOreReprocessing,MSMachine<TileEntityInfinityOreReprocessing>>,ItemBlockTooltip> INFINITY_ORE_REPROCESSING;
    ...
    static {
        ...
        CHEMICAL_DEMOLITION_MACHINE = BLOCKS.register("chemical_demolition_machine",() -> new BlockTile.BlockTileModel<>(MSBlockTypes.CHEMICAL_DEMOLITION_MACHINE, properties -> properties.strength(3.5F, 16F).requiresCorrectToolForDrops().mapColor(BlockResourceInfo.STEEL.getMapColor())),ItemBlockTooltip::new);
        ...
        INFINITY_ORE_REPROCESSING = BLOCKS.register("infinity_ore_reprocessing", () -> new BlockTile.BlockTileModel<>(MSBlockTypes.INFINITY_ORE_REPROCESSING, properties -> properties.strength(3.5F, 16F).requiresCorrectToolForDrops().mapColor(BlockResourceInfo.STEEL.getMapColor())), ItemBlockTooltip::new);
