...
public class MSFluids {
    ...
    public static final FluidRegistryObject<FluidDeferredRegister.MekanismFluidType, ?, ?, LiquidBlock, BucketItem> AMMONIUM_NITRATE_SOLUTION = FLUIDS.registerLiquidChemical(MSChemicalConstants.AMMONIUM_NITRATE_SOLUTION);
    public static final FluidRegistryObject<FluidDeferredRegister.MekanismFluidType, ?, ?, LiquidBlock, BucketItem> ANTIMATTER_FLUID      = FLUIDS.registerLiquidChemical(MSChemicalConstants.ANTIMATTER);
    //public static final FluidRegistryObject<...> AQUA_REGIA = FLUIDS.registerLiquidChemical(MSChemicalConstants.AQUA_REGIA);
    ...
    //public static final FluidRegistryObject<...> NETHERITE_ACID = FLUIDS.registerLiquidChemical(MSChemicalConstants.NETHERITE_ACID);
